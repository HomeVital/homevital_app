...
const HvInputField = ({ itemState, setItemState, description, metric, header='' }: Props) => {
return (
<View style={Styles.itemContainer}>
    <HvText weight='light' size='xl'>{header}</HvText>
    <View style={Styles.inputContainer}>
        <View style={Styles.descriptionContainer}>
            <HvText weight='semibold' size='xxl'>{description}</HvText>
